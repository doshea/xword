...
cro1.set_contents('ONION__AFT_CST_PANGE_DNAS_LOSTATORS_EDNA_OURSLONESTARCOUNTRY___SYDNEY_MEH__ABS__SSW_BASAL_NOOSE__SAR__SOBTRUELIE_WARMICEEAT__TAE__BEAKS_THAIS_MAS__NEO__HRS_IBERIA___BLACKSTARNATIONMANA_TERO_MOODYICON_ECGS_INTES_KIE_THO__TEASE')
cro2.set_contents('FIFA__SUEDE_PBRONIT_DITTOS_HEARAGECAGE_NOTREMALHEAR_RAINIER_ULTIMEMUT__GNI____REDASH_AROO_BOOTLEG_BEHOLDSOVA_PVN_LEE_OILOILOOIE_AWINGCO_NURX_SRSBRO____EMI__IATEDEMYO_WINEBAG_WOPPERPANASU_EMBOLISMFLU_ADORNS_ERGODKM_USESO__ALOT')
